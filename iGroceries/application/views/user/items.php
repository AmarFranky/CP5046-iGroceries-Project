								...
								<figure>
									...
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="<?php echo base_url();?>Shop/prod_details?id=<?php echo $row->item_id; ?>"><img src="<?php echo base_url();?>uploads/<?php echo $row->item_image;?>" alt=" " class="img-responsive" /></a>
