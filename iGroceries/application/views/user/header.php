...
<div class="container">
<div class="igs_logo_products_left">
	<h1><a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assetsUser/images/iglogo1.png" style="width:90px;height:90px;"></a></h1>
</div>
<div class="igs_logo_products_left1">
	<ul class="special_items" style="margin:-7px;">
	<li><a href="<?php echo base_url();?>" style="padding-right: 2.6em;margin: 1em 0;">Home</a></li>
		<li><a href="<?php echo base_url();?>Shop/about" style="padding-right: .6em;margin: 1em 0;">About Us</a></li>
