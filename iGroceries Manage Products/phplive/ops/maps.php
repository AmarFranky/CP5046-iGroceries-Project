...
<body id="info_content" style="margin: 0px; border: 0px; padding: 0px;">
	...
	<div id="map_default" style="display: none; height: 100%;">
		...
		<?php else: ?>
			...
			<div class="chat_info_td" style="padding: 10px; text-align: justify;">
				To enable GeoIP Location, contact the setup admin.  The setup admin will need to login to the Setup Admin area and access the top menu "Extras".  On the "Extras" page, click the "GeoIP" sub menu.
