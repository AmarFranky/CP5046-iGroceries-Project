...
<div style="margin-top: 25px; padding-top: 50px; padding-bottom: 50px; background: url(../pics/bg_fade_lite.png) no-repeat #272727; background-position: top center; border-top: 1px solid #272727; color: #686868;">
	<div style="width: 970px; margin: 0 auto; text-align: right;">
		<div id="chat_text_powered"><?php if ( $console || ( isset( $CONF["KEY"] ) && ( $CONF["KEY"] == md5($KEY."_key_phplive") ) ) ): ?><?php else: ?>powered by <a href="http://www.phplivesupport.com/?plk=pi-24-ysj-m" target="_blank">PHP Live!</a><?php endif ; ?></div>
