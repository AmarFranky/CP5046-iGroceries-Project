...
<!--
	...
	$(document).ready(function()
	{
		...
		$('#footprint_info_container').css({'min-height': div_height_container}) ;
				...
				if ( json_data.status )
				{
					...
					var traffic_string = "<table cellspacing=0 cellpadding=0 border=0 width=\"98%\" id=\"table_trs_traffic\">"+
						"<tr>"+
							...
							"<td width=\"45\"><div class=\"chat_info_td_t\" style=\"cursor: help;\" title=\"Total Footprints\" alt=\"Total Footprints\"><img src=\"../themes/<?php echo $theme ?>/info.png\" width=\"10\" height=\"10\" border=\"0\" title=\"Total Footprints\" alt=\"Total Footprints\"> t-f</div></td>"+
							"<td width=\"45\"><div class=\"chat_info_td_t\" style=\"cursor: help;\" title=\"Total Chat Requests\" alt=\"Total Chat Requests\"><img src=\"../themes/<?php echo $theme ?>/info.png\" width=\"10\" height=\"10\" border=\"0\" title=\"Total Chat Requests\" alt=\"Total Chat Requests\"> t-c</div></td>"+
							"<td width=\"45\"><div class=\"chat_info_td_t\" style=\"cursor: help;\" title=\"Total Operator Chat Invite\" alt=\"Total Operator Chat Invite\"><img src=\"../themes/<?php echo $theme ?>/info.png\" width=\"10\" height=\"10\" border=\"0\" title=\"Total Operator Chat Invite\" alt=\"Total Operator Chat Invite\"> t-i</div></td>"+
	...
	function populate_footprint( thevis_token, theduration, themarket, theip, theos, thebrowser, theresolution, thet_footprints, thet_requests, thet_initiates, thetitle, theonpage, therefer_snap, therefer_raw, thecountry, theregion, thecity, theinitiate )
	{
		...
		success: function(data){
			...
			if ( json_data.status )
			{
				...
				$('#info_platform').empty().html( "<img src=\"../themes/<?php echo $theme ?>/os/"+theos+".png\" border=0 alt=\""+theos+"\" title=\""+theos+"\" alt=\""+theos+"\" width=\"14\" height=\"14\"> &nbsp; <img src=\"../themes/<?php echo $theme ?>/browsers/"+thebrowser+".png\" border=0 alt=\""+thebrowser+"\" title=\""+thebrowser+"\" alt=\""+thebrowser+"\" width=\"14\" height=\"14\">" ) ;
	...
	function populate_requestinfo( theip, thevis_token, thecountry, theregion, thecity )
	{
		...
		success: function(data){
			...
			if ( json_data.status )
			{
				$('#info_duration').empty().html( " <span class=\"info_good\"><img src=\"../themes/<?php echo $theme ?>/info_chats.gif\" width=\"10\" height=\"10\" border=\"0\" alt=\"\" style=\"cursor: help;\" title=\"currently chatting with "+json_data.name+"\" alt=\"currently in a chat session with "+json_data.name+"\"></span>" ) ;
			}
...
<div id="canned_container" style="display: none; padding: 15px; height: 200px; overflow: auto;">
	<div style="padding-bottom: 45px; width: 98%;">
		...
		<div id="footprint_info_container" style="display: none;">
			...
			<div id="div_traffic_info_info" style="margin-top: 15px;">
				...
				<tr>
					<td class="chat_info_td_traffic" nowrap onClick="toggle_menu_info('initiate')" style="cursor: pointer;">Operator Chat Invite</td>
				...
				<tr>
					...
					<td class="chat_info_td_traffic">
						<div style="height: 180px; width: 98%; overflow: auto;" id="info_footprints"></div>
					</td>
					<?php endif;  ?>
				</tr>
				</table>
			...
			<div id="div_traffic_info_initiate" style="display: none; margin-top: 15px; overflow: auto;">
				...
				<div style="">
					...
					<?php if ( $CONF['icon_check'] == "on" ): ?>
						...
						<div style="margin-top: 5px;"><textarea id="chat_info_initiate_message" class="input_text" cols="50" rows="8" wrap="virtual"></textarea></div>

						<div style="margin-top: 25px;">or choose Canned Response:</div>
						...
						<div style="padding-top: 25px;">
							...
							<div style="margin-top: 5px;">
								...
								&nbsp;
								<button type="button" onClick="initiate_chat()" id="btn_initiate" class="input_op_button">Invite to chat</button>
							</div>
						</div>
					<?php else: ?>
						<div>Chat invite has been switched off by the Setup Admin (<code>Setup Admin -&gt; Traffic -&gt; Settings -&gt; Chat Icon Status Check</code>).</div>
					<?php endif ; ?>
