...
<div id="iframe_body" style="height: 440px; overflow: hidden; <?php echo ( $bgcolor ) ? "background: #$bgcolor;" : "" ?>">
	...
	<div id="">
		<div class="menu_dept" onClick="show_div('email')" id="menu2_trans_email">Visitor Email Transcript</div>
		<div class="menu_dept_focus" onClick="show_div('template')" id="menu2_trans_template">Transcript Message Template</div>
		<div style="clear: both"></div>
	</div>
	<div style="margin-top: 15px;">
		<div id="div_email" style="display: none;" class="info_info">
			<div style="padding-bottom: 15px; text-align: justify;">
				<div style="float: left; height: 160px; width: 360px" class="info_info">
					<div style="font-weight: bold; font-size: 14px;">Visitor Email Transcript</div>
					<div style="margin-top: 5px;">Provide visitors an option to receive the chat transcript by email during a chat session?  Selection "No" will hide the email transcript icon <img src="../themes/default/email.png" width="16" height="16" border="0" alt=""> during a chat session.</div>
				...
				<div style="float: left; margin-left: 2px; height: 160px; width: 360px;" class="info_info">
				...
				<tr>
					...
					<td valign="top" width="100%" style="padding-left: 15px;">
						...
						<div style="margin-top: 5px;">
							...
							<div style="margin-top: 15px;"><a href="JavaScript:void(0)" onClick="parent.do_options( 6, <?php echo $deptid ?>, '<?php echo $bgcolor ?>' )">custom field values</a> (if provided) will be placed right after the %%transcript%%</div>
						</div>
					</td>
				</tr>
				</table>
