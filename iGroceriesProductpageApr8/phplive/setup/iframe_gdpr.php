...
<div id="div_policy_wrapper" style="position: fixed; top: -500px; left: 0px; width: 90%; padding: 2px; -webkit-box-shadow: -0px 7px 29px rgba(0, 0, 0, 0.34); -moz-box-shadow: 0px 7px 29px rgba(0, 0, 0, 0.34); box-shadow: 0px 7px 29px rgba(0, 0, 0, 0.34); z-Index: 10;" class="info_content">
