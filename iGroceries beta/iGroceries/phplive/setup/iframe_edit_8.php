...
<div id="iframe_body" style="height: 390px; overflow: hidden; <?php echo ( $bgcolor ) ? "background: #$bgcolor;" : "" ?>">
	...
	<div style="">
		<div style="">Automatically set department to go Offline at a specific time.  The online operators will be automatically logged off and to limit accidental online status during offline hours, the system will also prevent the operator from going online during the "Offline Duration".  Active chat sessions will not be interrupted.  Automatic logout will process when the chat has ended and the operator has zero chats.  However, the chat icon will display offline status at the Automatic Offline time.</div>
