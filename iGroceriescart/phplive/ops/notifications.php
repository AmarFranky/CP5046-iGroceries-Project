...
<?php include_once( "./inc_header.php" ); ?>
		...
		<div class="op_submenu_wrapper">
			<div class="op_submenu" style="margin-left: 0px;" onClick="show_div('sounds')" id="menu_sounds">Sound Alerts and Console Blink</div>
		...
		<div id="op_sounds" style="display: none; margin-top: 15px;">
			<?php if ( !$console ): ?><div style="margin-bottom: 25px;">If settings are updated and the <a href="index.php?jump=online">operator chat console</a> is open, you will need to refresh the console for the changes to take effect.</div><?php endif ; ?>
			...
			<tr>
				...
				<td valign="top" style="padding-left: 50px;" id="td_sound">
					...
					<tr>
						...
						<td class="td_dept_td"><div style="margin-left: 15px; cursor: pointer;" onClick="demo_sound1(1)">play sound</div></td>
						<td class="td_dept_td"><div style="margin-left: 15px; cursor: pointer;" onClick="demo_sound1(0)">stop sound</div></td>
					</tr>
					<tr>
							...
							<?php
								...
								for ( $c = 0; $c < count( $sounds ); ++$c )
								{
									...
									if ( preg_match( "/[a-z]/i", $sound ) && preg_match( "/^new_text_/i", $sound ) )
									{
										...
										if ( !isset( $sounds_filter[$sound_temp] ) && ( $sound_temp != "default" ) && ( $sound_temp != "return" ) )
										{
											$sounds_filter[$sound_temp] = 1 ;
						...
						<td class="td_dept_td"><div style="margin-left: 15px; cursor: pointer;" onClick="demo_sound2()">play sound</div></td>
		...
		<div id="op_sms" style="display: none; margin-top: 15px;">
			...
			<?php if ( isset( $CONF['MAPP_KEY'] ) && $CONF['MAPP_KEY'] ): ?>
				...
				<div style="margin-top: 55px;" id="div_mobileapp_siteid">
					...
					<div style="font-size: 18px; font-weight: bold;">
						<table cellspacing=0 cellpadding=0 border=0>
						<tr>
							<td><img src="../pics/icons/mobile_big.png" width="48" height="48" border="0" alt=""></td>
							<td><b>Mobile App Site ID:</b> <span id="div_kpr" class="info_box"><?php echo $kpr ?></span> - <span id="div_kpo" class="info_box"><?php echo $kpo ?></span></td>
						</tr>
						</table>
					</div>
				</div>
			...
			<?php else: ?>
				<div style="margin-top: 10px;" class="info_error">
					...
					<div style="margin-top: 15px;">After the Site ID has been generated, <a href="JavaScript:void(0)" onClick="location.href='notifications.php?jump=sms&console=<?php echo $console ?>'" style="color: #FFFFFF;">refresh this page</a> to continue.</div>
				</div>
			<?php endif ; ?>
		...
		<div id="op_dn" style="display: none; margin-top: 15px;">
			<img src="../pics/icons/computer_big.png" width="48" height="48" border="0" alt=""> Display a new chat request/response notification on the desktop.  Desktop notification is currently available for <a href="https://www.google.com/chrome" target="new">Google Chrome</a>, <a href="http://www.firefox.com" target="new">Firefox</a> and <a href="https://www.microsoft.com/en-us/windows/microsoft-edge" target="new">IE Edge</a>.
			...
			<tr>
				<td >
					...
					<div id="dn_winapp" style="display: none;">
						...
						<tr>
							...
							<td valign="top" style="padding-left: 50px;">
								...
								<div style="margin-top: 15px; text-align: center;">
									<button type="button" class="btn" onClick="dn_show( 'new_chat', '<?php echo time() ?>', 'Demo Visitor', 'This is a demo chat request question.', 45000 )">Click Here to display a demo desktop notification.</button>
								</div>
