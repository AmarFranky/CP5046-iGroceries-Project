...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div class="op_submenu2" onClick="location.href='reports_chat_msg_urls.php'">Message URLs</div>
			<div style="clear: both"></div>
		</div>
		...
		<div style="margin-top: 25px;">
			...
			<tr>
				<td colspan=2 style="padding-top: 5px;">
					...
					<div style="margin-top: 15px;"><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""> When a visitor leaves an offline message, the message is emailed to the <a href="depts.php">department</a> email address.  These are the saved copies of the sent messages.</div>
				</td>
			</tr>
			</table>
			</form>
		...
		<?php
			for ( $c = 0; $c < count( $messages ); ++$c )
			{
				...
				if ( $message["custom"] )
				{
					...
					$custom_vars_string = ( $custom_vars_string ) ? "<div style=\"margin-top: 5px;\" class=\"info_neutral\"><table cellspacing=0 cellpadding=0 border=0 width=\"100%\"><tr><td width=\"118\">Custom Variables</td><td style=\"padding-left: 15px;\"><div style=\"max-height: 65px; overflow: auto;\">$custom_vars_string</div></td></tr></table></div>" : "" ;
				}
				...
				print "<tr id=\"tr_$message[messageID]\" style=\"background: #$bg_color;\"><td class=\"$td1\">$btn_view</td><td class=\"$td1\" nowrap>$created_date<div style=\"font-size: 10px; margin-top: 3px;\">($created_time)</div></td><td class=\"$td1\">$visitor<div style=\"margin-top: 5px;\"><a href=\"mailto:$message[vemail]\">$message[vemail]</a></div></td><td class=\"$td1\">$department</td><td class=\"$td1\" nowrap>$message[footprints]</td><td class=\"$td1\"><div id=\"div_$message[messageID]\" style=\"word-break: break-word; word-wrap: break-word;\">$message[subject]$custom_vars_string</div></td></tr>" ;
			}
			if ( $c == 0 )
