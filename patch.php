...
<!--
	...
	var loader_c ;
	var dev = 0 ; // interface preview and design
	var dev_c = 0 ; var total_qc = 0 ;
	var si_loader ;
...
<div style="width: 310px; margin: 0 auto; margin-top: 55px; padding: 10px;">
	...
	<div id="div_configure" style="text-align: center;">
		<div style=""><?php if ( isset( $CONF["KEY"] ) && ( $CONF["KEY"] == md5($KEY."_key_phplive") ) ): ?><?php else: ?><img src="pics/logo_new.png" border="0" alt=""><?php endif ; ?></div>
		<div style="margin-top: 15px;">
			<div id="div_configuring" style="padding-bottom: 15px; text-shadow: none;" class="info_clear">
				Updating and patching the system...
			</div>
			<div style="margin-top: 15px;" class="info_blue">
				<center>
				<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					<td>
						<div id="loading" style="width: 48px;">
							<span id="image_1"><img src="pics/loading_patch_1.gif" width="38" height="38" border="0" alt="" style="background: #FBFBFB; -moz-border-radius: 5px; border-radius: 5px; padding: 2px; box-shadow: 2px 2px 15px rgba(0, 0, 0, 0.2);"></span>
							<span id="image_2" style="display: none;"><img src="pics/loading_patch_2.gif" width="38" height="38" border="0" alt="" style="background: #FBFBFB; -moz-border-radius: 5px; border-radius: 5px; padding: 2px; box-shadow: 2px 2px 15px rgba(0, 0, 0, 0.2);"></span>
							<span id="image_3" style="display: none;"><img src="pics/loading_patch_3.gif" width="38" height="38" border="0" alt="" style="background: #FBFBFB; -moz-border-radius: 5px; border-radius: 5px; padding: 2px; box-shadow: 2px 2px 15px rgba(0, 0, 0, 0.2);"></span>
						</div>
					</td>
					<td style="padding-left: 15px;"><div style="font-size: 24px; font-weight: bold;"><span id="status">1</span>%</div></td>
				</tr>
				</table>
				</center>
			</div>
