			...
			<div class="agileinfo_single">
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						...
						<button class="btn btn-submit" onclick="window.location.href='<?php echo base_url();?>Shop/pay_form?id=<?php echo $row->item_id; ?>';" style="color:white;background:maroon
                        
                        
                        ">Buy Now</button>
                        
						<a class="btn btn-primary" href="<?php echo base_url("Shop/add/".$row->item_id);?>" class="hvr-bounce-to-bottom" style="background:#f49239;">Add To Cart</a>
					</div>
				</div>
