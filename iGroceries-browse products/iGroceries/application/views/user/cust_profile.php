...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Simple profile UI</title>
...
<div class="content-profile-page">
   <div class="profile-user-page card">
      <div class="img-user-profile">
        <img class="profile-bgHome" src="<?php echo base_url();?>assetsUser/plain_green.jpg" />
        <img class="avatar" src="<?php echo base_url();?>uploads/<?php echo $row->image;?>" alt="jofpin"/>
           </div>
          <button><?php if($row->gender=='M'){echo 'MALE'; }else {echo 'FEMALE'; } ?></button>
          <div class="user-profile-data">
            <h1><?php echo $row->fname; ?> <?php echo $row->lname;?></h1>
            <p><?php echo $row->email; ?></p>
          </div> 
          <ul class="data-user">
        <li><a><strong>Address</strong><span><?php echo $row->address; ?></span></a></li>
        <li><a><strong>Contact</strong><span><?php echo $row->contact; ?></span></a></li>
