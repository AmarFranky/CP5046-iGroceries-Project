...
<div id="iframe_body" style="height: 440px; overflow: hidden; <?php echo ( $bgcolor ) ? "background: #$bgcolor;" : "" ?>">
	<div class="info_info">
		...
		<div style="margin-top: 15px;">
			<div class="info_box"><img src="../pics/icons/info.png" width="12" height="12" border="0" alt="enabled"> SMTP settings can be updated at the <a href="../addons/smtp/smtp.php?deptid=<?php echo $deptid ?>" target="_parent">SMTP</a> area.</div>
		</div>

		<div style="margin-top: 15px;">
			<div id="div_alert" style="display: none; margin-bottom: 15px; text-shadow: none;"></div>
			<div><b>Check if the server can send out emails</b> &rarr; <button type="button" class="btn" onClick="parent.send_test_email(<?php echo $deptid ?>, '<?php echo $deptinfo["email"] ?>');" id="btn_send_email">Send Test Email to <?php echo $deptinfo["email"] ?></button></div>
		</div>
	</div>
</div>
