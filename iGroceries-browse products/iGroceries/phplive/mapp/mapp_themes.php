				...
				<td>
					<?php
						...
						for ( $c = 0; $c < count( $themes ); ++$c )
						{
							...
							if ( preg_match( "/[a-z]/i", $theme_temp ) && !preg_match( "/^\./", $theme_temp ) && ( $theme_temp != "initiate" ) )
								print "<div class=\"li_mapp round\" style=\"width: 85px; margin-bottom: 15px;\"><div style=\"background: url( $path_thumb ); background-position: top left; height: 54px; -moz-border-radius: 5px; border-radius: 5px; cursor: pointer;\" onClick=\"confirm_theme('$theme_temp', '$path_thumb')\"><input type=\"radio\" name=\"theme\" id=\"theme_$theme_temp\" value=\"$theme_temp\" $checked> <span class=\"info_mapp_neutral\">$theme_display</span></div></div>" ;
						}
					?>
					<div style="clear: both;"></div>
				</td>
			...
			<div id="div_settings_sounds_form" style="display: none; margin-top: 35px;">
				...
				<div>
					...
					<tr>
						...
						<td class="chat_info_td_traffic" style="padding-left: 15px;"><div style="cursor: pointer;" onClick="demo_sound1(1)">play sound</div></td>
						<td class="chat_info_td_traffic" style="padding-left: 15px;"><div style="cursor: pointer;" onClick="demo_sound1(0)">stop sound</div></td>
					</tr>
					</table>
				</div>
				...
				<div>
					...
					<tr>
						...
						<td class="chat_info_td_traffic" style="padding-left: 15px;"><div style="cursor: pointer;" onClick="demo_sound2()">play sound</div></td>
						<td class="chat_info_td_traffic">&nbsp;</td>
					</tr>
					</table>
				</div>

				<div style="padding-top: 35px;"><button type="button" onClick="update_sound_doit()" class="input_op_button">Update Sound Alerts</button></div>
				</form>
			</div>
