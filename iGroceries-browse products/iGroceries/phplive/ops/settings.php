...
<?php include_once( "./inc_header.php" ); ?>
		...
		<div id="op_pic" style="display: none; margin-top: 15px;">
			...
			<div style="margin-top: 15px;">
				<div style="display: inline-block;" class="info_info">
					...
					<tr>
						<td><img src="<?php print Util_Upload_GetLogo( "profile", $opinfo["opID"] ) ?>" width="55" height="55" border=0 style="border: 1px solid #DFDFDF;" class="round" id="img_profile_pic"></td>
				...
				<?php
					// disabled for operator area.  they have the ability to upload a new picture
					if ( 0 && $opinfo["opID"] && ( Util_Upload_GetLogo( "profile", 0 ) != Util_Upload_GetLogo( "profile", $opinfo["opID"] ) ) && isset( $opvars["pic_edit"] ) && $opvars["pic_edit"] ):
				?>
			...
			<div style="margin-top: 15px;">
				...
				<tr>
					...
					<td valign="top" style="padding-left: 50px;">
						<div><span class="info_neutral">Current list of shortcut commands:</span></div>
						<div style="margin-top: 10px;">
					...
					<td valign="top" style="padding-left: 5px;">
						<div><span class="info_neutral">Shortcut usage screenshot:</span></div>
						<div style="margin-top: 10px;"><img src="../pics/screens/shortcuts.gif?<?php echo $VERSION ?>" width="328" height="190" border="0" alt="" class="round" style="box-shadow: 1px 1px 15px rgba(0, 0, 0, 0.2);"></div>
					</td>
				</tr>
				</table>
			</div>
		...
		<div id="op_auto" style="display: none; margin-top: 15px;">
			...
			<div style="margin-top: 15px;">
				Skip the sign in process on the login page and automatically login.
				...
				<div style="margin-top: 10px;" class="info_neutral">
					...
					<tr>
						...
						<td>
							...
							<ul style="margin-top: 15px;">For example:
								...
								<li style="margin-top: 5px;"> For security, if you enabled the "Automatic Login" on <b>computer A</b> and then you login from <b>computer B</b>, it will clear the "Automatic Login" at computer A and all other computers that may have the "Automatic Login" enabled for your account.</li>
							</ul>
						</td>
					</tr>
					</table>
		...
		<div id="op_sleep" style="display: none; margin-top: 15px;">
			...
			<div id="op_sleep_browser" style="margin-top: 15px;">
				...
				<tr>
					...
					<td valign="top" style="padding-left: 50px;">
						<div><span class="info_neutral"><i>Sleep Lock</i> will have the following lock/prevent behaviors depending on the brower type:</span></div>
						<div style="margin-top: 10px;">
		...
		<div id="op_password" style="display: none; margin-top: 15px;">
			...
			<img src="../pics/icons/key_big.png" width="48" height="48" border="0" alt="">Update Your Password

			<div style="margin-top: 15px;">Current Password</div>
			<div><input type="password" class="input" name="password" id="password" size="30" value=""></div>
			...
			<div style="margin-top: 25px;">
				...
				<div><input type="password" class="input" name="npassword" id="npassword" size="30" value="" onKeyPress="return noquotes(event)"></div>

				<div style="margin-top: 15px;">Verify New Password</div>
				<div><input type="password" class="input" name="vpassword" id="vpassword" size="30" value="" onKeyPress="return noquotes(event)"></div>
