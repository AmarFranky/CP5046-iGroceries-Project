...
<?php include_once( "../../setup/inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div style="margin-top: 15px;">Add additional expressiveness with emoticons of ecstatic, happy, thumbs up and more.  Emoticons <img src="smile.png" width="20" height="20" border="0" alt=""> will be visible on the chat window during a chat session for both the visitor and the operator.</div>

			<?php if ( count( $departments ) > 1 ): ?>
			<div style="display: none; margin-top: 15px;" class="info_info">
				<div class="info_good" style="float: left; cursor: pointer;"><button onclick="confirm_emo_onoff(0, 'on');" class="btn">Enable Emoticons for ALL Departments</button></div>
			...
			<div style="margin-top: 15px;"><span class="info_error"><img src="../../pics/icons/warning.png" width="12" height="12" border="0" alt=""> Add a <a href="../../setup/depts.php" style="color: #FFFFFF;">Department</a> to continue.</span></div>
			<?php else: ?>
