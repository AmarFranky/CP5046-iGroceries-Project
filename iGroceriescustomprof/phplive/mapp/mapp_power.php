...
<!--
	"use strict" ;
	var base_url = ".." ;
	var global_status = <?php echo $opinfo["status"] ?> ;
...
<div id="canned_container" style="padding: 15px; padding-top: 25px; height: 200px; overflow: auto;">
	...
	<div id="div_settings_profile" style="margin-top: 25px; padding-bottom: 50px;">
		<div class="info_content">
			...
			<div style="margin-top: 5px;">
				<div class="info_mapp_good" style="float: left; width: 60px; cursor: pointer;"onClick="update_status(1)"><input type="radio" name="r_status" id="r_status_1" value="on" <?php echo ( $opinfo["status"] ) ? "checked" : "" ; ?>> Online</div>
		...
		<div style="margin-top: 25px; text-align: justify;">
			...
			<div style="margin-top: 15px;"><button type="button" onClick="parent.refresh_console(0);" class="input_op_button" style="padding: 10px;">Refresh Operator Console</button></div>
		</div>
	</div>
	<div id="div_settings_network" style="display: none; margin-top: 25px; padding-bottom: 50px;">
