		...
		<div class="op_submenu_wrapper">
			...
			<div class="op_submenu" onClick="location.href='<?php echo $CONF["BASE_URL"] ?>/setup/code_autostart.php'" id="menu_code_autostart">Automatic Start Chat</div>
			...
			<div class="op_submenu" onClick="location.href='<?php echo $CONF["BASE_URL"] ?>/setup/code_settings.php'" id="menu_code_settings">Settings</div>
