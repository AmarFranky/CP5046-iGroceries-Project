...
<div id="info_disconnect_mapp" class="info_disconnect" style="position: absolute; display: none; top: 0px; right: 0px; z-Index: 105;" onClick="pre_disconnect();"></div>

<div id="div_menu_prefs" style="display: none; position: absolute; bottom: 0px; right: 0px; width: 200px; height: 280px; background: url( ../pics/glass/glass_grey.png ) repeat-x #61696D; border-top-left-radius: 10px 10px; -moz-border-radius-topleft: 10px 10px; z-Index: 106;">
