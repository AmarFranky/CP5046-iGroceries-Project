...
<div id="header_wrapper" style="background: url( <?php echo $CONF["BASE_URL"] ?>/pics/bg_header_shadow.png ) repeat-x #49586C; background-position: bottom;">
	<div style="">
		<div style="width: 970px; margin: 0 auto;">
			<div id="menu_wrapper" style="padding-top: <?php echo ( $console ) ? 5 : 35 ; ?>px; padding-bottom: <?php echo ( $console ) ? 5 : 35 ; ?>px;">
				<?php if ( !$console ): ?><div id="menu_go" class="menu" onClick="<?php echo ( preg_match( "/(cans)|(notifications)|(transcript)|(activity)|(report)|(settings)/", $menu ) ) ? "location.href='./index.php?console=$console&auto=$auto&$cache_bypass'" : "toggle_menu_op('go')" ; ?>"><img src="../pics/icons/bulb.png" width="12" height="12" border="0" alt="" style="padding: 2px; background: #49586C;" class="round"> Go ONLINE!</div><?php endif ; ?>
				<div id="menu_themes" class="menu" style="<?php echo ( !$console ) ? "display: none; " : "" ; ?>" onClick="<?php echo ( preg_match( "/(cans)|(notifications)|(transcript)|(activity)|(report)|(settings)/", $menu ) ) ? "location.href='./index.php?menu=themes&console=$console&auto=$auto&$cache_bypass'" : "toggle_menu_op('themes')" ; ?>"><img src="../pics/icons/menu_icons.png" width="12" height="12" border="0" alt="" style="padding: 2px; background: #49586C;" class="round"> Themes</div>
				<div id="menu_notifications" class="menu" onClick="location.href='./notifications.php?console=<?php echo $console ?>&auto=<?php echo $auto ?>&<?php echo $cache_bypass ?>'"><img src="../pics/icons/menu_sound.png" width="12" height="12" border="0" alt="" style="padding: 2px; background: #49586C;" class="round"> Notifications</div>
				<?php if ( !$console ): ?>
				...
				<div id="menu_activity" class="menu" onClick="location.href='./activity.php?console=<?php echo $console ?>&auto=<?php echo $auto ?>&<?php echo $cache_bypass ?>'"><img src="../pics/icons/menu_calendar.png" width="12" height="12" border="0" alt="" style="padding: 2px; background: #49586C;" class="round"> Online Activity</div>
...
<div style="width: 100%; background: url( ../pics/bg_shadow.png ) repeat-x; padding-top: <?php echo ( $console ) ? 5 : 25 ; ?>px;" id="div_body_container">
	<div style="width: 970px; margin: 0 auto; text-align: right;">
		...
		<tr>
			...
			<?php if ( !$console ): ?>
			<td width="160" nowrap>
				<div style="padding: 10px; text-align: center; background: #8BCF92; border: 1px solid #82C289;" class="round_top"><img src="<?php echo $CONF["BASE_URL"] ?>/pics/icons/bulb_big.png" width="24" height="24" border="0" alt="" id="img_bulb"> <a href="index.php?jump=online&<?php echo $cache_bypass ?>" style="color: #FFFFFF;">Go <span style="">ONLINE!</span></a></div>
			</td>
			<?php endif ; ?>
			<td align="right" style="padding-left: 15px;" nowrap>
				<div style="padding: 10px; text-align: center;" class="round_top"><img src="../pics/icons/user_big.png" width="24" height="24" border="0" alt=""> Chat Operator: <span style="font-size: 14px;"><a href="./settings.php?console=<?php echo $console ?>&auto=<?php echo $auto ?>&<?php echo $cache_bypass ?>"><?php echo $opinfo["login"] ?></a></span> <?php if ( !$console ): ?>&nbsp; &bull; &nbsp; <a href="JavaScript:void(0)" onClick="logout_op()">logout</a><?php endif ; ?></div>
			</td>
		</tr>
		</table>
	</div>
