<?php
						...
						$status = 0 )
	{
		...
		$query = "SELECT * FROM p_operators, p_dept_ops WHERE p_operators.opID = p_dept_ops.opID $dept_string $status_string GROUP BY p_dept_ops.opID ORDER BY p_dept_ops.display ASC" ;
		database_mysql_query( $dbh, $query ) ;
