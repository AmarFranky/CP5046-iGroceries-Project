...
<div class="modal fade" id="myModal" role="dialog">
  ...
  <a href="<?php echo base_url();?>Shop/get_beverages" class="list-group-item list-group-item-action">Beverages</a>
  <a href="<?php echo base_url();?>Shop/get_bread" class="list-group-item list-group-item-action">Bread/Bakery</a>
  <a href="<?php echo base_url();?>Shop/get_frozen" class="list-group-item list-group-item-action">Frozen Foods</a>
  <a href="<?php echo base_url();?>Shop/get_cleaners" class="list-group-item list-group-item-action disabled">Cleaners</a>
  <a href="<?php echo base_url();?>Shop/get_canned" class="list-group-item list-group-item-action disabled">Canned/Jarred Goods</a>
  <a href="<?php echo base_url();?>Shop/get_dry" class="list-group-item list-group-item-action disabled">Dry/Baking Goods</a>
  <a href="<?php echo base_url();?>Shop/get_dairy" class="list-group-item list-group-item-action disabled">Dairy</a>
  <a href="<?php echo base_url();?>Shop/get_personal" class="list-group-item list-group-item-action disabled">Personal Care</a>
  <a href="<?php echo base_url();?>Shop/get_others" class="list-group-item list-group-item-action disabled">Others</a>
...
<div class="modal fade" id="loginModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<div class="row">
		<div class="list-group">
		<form action="<?php echo base_url();?>Shop/isLogiCustomer" method="post">
		...
		<input type="button" value="Register" onclick="window.location.href='<?php echo base_url();?>Shop/signup'" class="btn btn-default" >
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </div>
      </form>
...
<div class="agileits_header" style="background:#062a06;">
		...
		<div class="ig_search">
			<form action="<?php echo base_url();?>Shop/search_res" method="post">
				<input type="text" name="pname" value="Search a product..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search a product...';}" required="">
				<input type="submit" value=" ">
			</form>
		</div>
		<div class="product_list_header">  
			<form action="<?php echo base_url();?>Shop/cart" method="post" class="last">
                <fieldset>
                   
                    <button style="background:#81b107;width: 50px;height: 40px;" onclick="window.location.href='<?php echo base_url();?>Shop/cart';"  /><i style="color:red;" class="fa fa-shopping-cart"></i><?php echo count($this->cart->contents());?></button>
				             </fieldset>
            </form>
		</div>
					...
					<div class="mega-dropdown-menu">
						<div class="igs_vegetables">
							<ul class="dropdown-menu drp-mnu">
								...
								<li><a href="<?php echo base_url();?>Shop/cust_profile">Profile</a></li>
							</ul>
						</div>                  
					</div>	
				</li>
...
<div class="igs_logo_products_left1">
	...
	<li><a href="#" style="margin-left:35px;" data-toggle="modal" data-target="#myModal">Products</a><i></i></li>
		<li><a href="<?php echo base_url();?>Shop/loadContact" style="padding-right: .6em;margin: 1em 0;">Contact Us</a><i></i></li>
