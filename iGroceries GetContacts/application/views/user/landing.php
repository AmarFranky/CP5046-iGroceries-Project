...
<?php if($this->session->flashdata('success')){ ?>
					...
					<strong id="myWish"><?php echo $this->session->flashdata('success');?></strong> 					</div>
<?php } ?>	
<!--<section>-->
		...
		<ul class="slides">
			<li>
				<div class="ig_banner_nav_right_banner1">
					<div class="more">
						<a href="<?php echo base_url(); ?>Shop/get_dairy" style="margin-top: 250px;" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
					</div>
				</div>
			</li>
			<li>
			...
			<li>
				<div class="ig_banner_nav_right_banner3">
					<div class="more">
						<a href="<?php echo base_url(); ?>Shop/get_bread" style="margin-top: 250px;" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
					</div>
				</div>
			</li>
			<li>
			...
			<li>
				<div class="ig_banner_nav_right_banner5">
					<div class="more">
						<a href="<?php echo base_url(); ?>Shop/get_beverages" style="margin-top: 250px;" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
					</div>
				</div>
			</li>
			<li>
				<div class="ig_banner_nav_right_banner6">
					<div class="more">
						<a href="<?php echo base_url(); ?>Shop/get_frozen" style="margin-top: 250px;" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
					</div>
				</div>
			</li>
			<li>
				<div class="ig_banner_nav_right_banner7">
					<div class="more">
						<a href="<?php echo base_url(); ?>Shop/get_canned" style="margin-top: 250px;" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
					</div>
				</div>
			</li>
			<li>
				<div class="ig_banner_nav_right_banner8">
					<div class="more">
						<a href="<?php echo base_url(); ?>Shop/get_personal" style="margin-top: 250px;" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
					</div>
				</div>
			</li>
				...
				<div class="col-md-3 top_brand_left">
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1" style="height:330px;">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="#"><img title=" " alt=" " class="img-responsive" src="<?php echo base_url()?>uploads/<?php echo $row->item_image; ?>" style="width:100px;height:150px;" /></a>		
											<p><?php echo $row->item_name; ?></p>
											<h4>$<?php echo $row->item_price; ?></h4>
										</div>
										
						  <a class="btn btn-primary" href="<?php echo base_url("Shop/add/".$row->item_id);?>" class="hvr-bounce-to-bottom" style="background:#84c639;color:white;margin-top:15px;">Add To Cart</a>
