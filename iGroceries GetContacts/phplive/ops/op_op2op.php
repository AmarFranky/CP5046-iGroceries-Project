...
<div id="canned_container" style="display: none; padding: 15px; height: 200px; overflow: auto;">
	<div style="">
		View all operators and their online/offline status, request Operator-to-Operator chat with other online operators and view all departments and the operators assigned to the department.  If an operator is assigned to multiple department, the ability to go online or offline for a specific department is also available in this area.
