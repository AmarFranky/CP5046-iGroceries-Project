...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div style="margin-top: 25px;">
				<div style="">On webpages containing the <a href="./code.php">Standard HTML Code</a>, automatically display a chat invite image to the visitor when certain criterias are met AND when an operator is Online.</div>
