<?php
	...
	else if ( $action === md5( $q ) )
	{
		...
		if ( !$error )
		{
			...
			{
				$error = "MySQL Host or login information is invalid. [myi]" ;
				$sql_type = "SQLi.php" ;
				...
				if ( $connection->connect_errno && is_numeric( $connection->connect_errno ) ) { $error = "MySQL Host or login information is invalid. [i: ".$connection->connect_errno."]" ; }
				else{
			...
			else
			{
				...
				try {
					...
					$error = "MySQL host, login, password or database name ($db_name) is invalid." ;
				}
			}
...
<!--
	...
	function install()
	{
		...
		var db_login = $('#db_login').val().trim() ; $('#db_password').val().trim() ;
...
<div id="body" style="width: 970px; margin: 0 auto; margin-top: 15px;">
	...
	<div style="padding: 20px;" class="info_misc">
		<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td style="font-size: 20px;"><div class="info_neutral" style="padding: 10px;"><img src="../pics/logo_new.png" width="120" height="25" border="0" alt=""></div></td>
			<td style="padding-left: 25px;">
				<div style="font-size: 20px;">Live Chat Software Installation</div>
	...
	<div style="margin-top: 5px; -webkit-box-shadow: -0px 7px 29px rgba(0, 0, 0, 0.34); -moz-box-shadow: 0px 7px 29px rgba(0, 0, 0, 0.34); box-shadow: 0px 7px 29px rgba(0, 0, 0, 0.34);" class="info_info">
			...
			<td valign="top" width="45%" style="">
				...
				<tr>
					<td colspan=2>
						...
						<div style="margin-top: 15px; text-align: justify;">The Setup Admin has access to all the setup features such as creating departments, creating operators, upload chat icons, view chat reports, all the administration features.</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="td_dept_td_blank noshadow" nowrap>Your Email</td>
					<td class="td_dept_td_blank noshadow"><input type="text" class="input" size="25" maxlength="160" name="email" id="email" onKeyPress="return justemails(event)" value=""><div style="margin-top: 5px; font-size: 10px;"><span class="info_box">* used for password recovery and system alerts</span></div></td>
				</tr>
				<tr>
			...
			<td valign="top" width="45%" style="">
				...
				<tr>
					...
					<td class="td_dept_td_blank noshadow">
						<select id="db_type" name="db_type" class="select">
							<?php if ( function_exists('mysqli_connect') ): ?><?php else: ?><option value="mysql">MySQL</option> <?php endif ; ?>
				...
				<tr>
					...
					<td style="padding-top: 15px; padding-left: 15px;">
						<div style="margin-bottom: 15px;" id="div_license_agree"><input type="checkbox" id="license_agree"> By installing the software, you agree to the <a href="https://www.phplivesupport.com/copyright.php" target="license">PHP Live! Software License Agreement</a></div>
		...
		<div style="margin-top: 55px; padding-top: 15px; border-top: 1px solid #BFC6CC;">For installation assistance, please visit the <a href="https://www.phplivesupport.com/r.php?r=install&plk=pi-23-78m-m&key=<?php echo $KEY ?>" target="_blank">knowledge base</a>. &copy; PHP Live LLC</div>
	</div>
	</form>
</div>
