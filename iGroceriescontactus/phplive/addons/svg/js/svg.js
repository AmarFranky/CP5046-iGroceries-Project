...
function svg_submit( theicon, thetype )
{
	...
	$('#btn_svg_'+theicon).attr( "disabled", true ) ;
	...
	if ( !svg_submit_status )
	{
		...
		$.ajax({
			...
			data: "action=update_svg&deptid="+deptid+"&icon="+theicon+"&t="+thetype+"&o="+outer+"&i="+inner+"&d="+dots+"&text="+text+"&"+unixtime(),
			success: function(data){
				...
				$('#btn_svg_'+theicon).attr( "disabled", false ) ;
				...
				if ( json_data.status )
				{
					...
					svg_update( theicon ) ;
					toggle_type( thetype, theicon ) ;
					toggle_status( thetype, theicon ) ;

					$('#image_'+theicon+'_status_'+thetype).prop( "checked", true ) ;
