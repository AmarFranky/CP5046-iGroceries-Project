<?php
	...
	$operators = Ops_get_AllOps( $dbh, 1 ) ; $total_operators = count( $operators ) ;
	...
	$operator_pic_display = 0 ;
	$operators_hash = Array() ;
	for ( $c = 0; $c < $total_operators; ++$c )
	{
		$operator = $operators[$c] ;
		$operators_hash[$operator["opID"]] = $operator["name"] ;
		if ( $operator["pic"] ) { $operator_pic_display = 1 ; }
	}
	...
	$chat_end_message_enabled = 0 ; $gdpr_msg_enabled = 0 ;
	$departments_vars = Depts_get_AllDeptsVars( $dbh ) ;
	foreach ( $departments_vars as $deptid => $deptinfo )
	{
		if ( $deptinfo["end_chat_msg"] )
			$chat_end_message_enabled = 1 ;
		if ( $deptinfo["gdpr_msg"] )
			$gdpr_msg_enabled = 1 ;
	}
...
<!--
	...
	function select_date_chat( theunix, thedayexpand, thetotal, thec, theincro )
	{
		...
		{
			global_c_chat = thec ;
			$('#stat_day_expand_chat').html( "<span class=\"info_blue_dark\" style=\"font-weight: bold;\">"+thedayexpand+"</span> &nbsp; Chat Requests: "+thetotal ) ;
			...
			<tr>
				<td valign="top">
					...
					<div class="home_box" style="width: 210px; margin-left: 0px;">
						<div style="padding: 10px; padding-top: 0px; padding-bottom: 0px;"><a href="interface.php?jump=logo"><img src="<?php echo $global_default_logo ?>" style="max-width: 100%;" border=0></a></div>
						...
						<div style="margin-top: 10px; padding: 10px;">
							...
							<tr>
								<td style="padding-top: 10px; padding-bottom: 10px;">Total Departments</td>
								<td style="padding-left: 5px; padding-top: 10px; padding-bottom: 10px;"><span class="info_neutral" onClick="location.href='depts.php'" style="cursor: pointer;"><b><?php echo count( $departments ) ?></b></span></td>
							</tr>
							<tr>
						...
						<div style="padding: 10px; padding-bottom: 5px;" class="title"><img src="../themes/default/profile_vis.png" width="16" height="16" border="0" alt=""> <a href="ops.php">Chat Operators (<?php echo $total_operators ?>)</a></div>
						<div style="padding: 10px; max-height: 250px; overflow: auto;">
							<?php
								for ( $c = 0; $c < $total_operators; ++$c )
								{
									...
									print "<div style=\"margin-bottom: 5px;\">$status_img $name</div>" ;
								}
								if ( !$total_operators )
									print "<div class=\"info_error\" style=\"margin-bottom: 5px;\"><img src=\"../pics/icons/warning.png\" width=\"12\" height=\"12\" border=\"0\" alt=\"\"> Add an <a href=\"ops.php\" style=\"color: #FFFFFF;\">Operator</a></div>" ;
							?>
						</div>
						<div style="padding: 10px;" class="info_neutral"><a href="JavaScript:void(0)" onClick="launch_tools_op_status()"><img src="../pics/icons/group.png" width="16" height="16" border="0" alt=""> Open Operator Status Monitor</a></div>

						<div style="margin-top: 15px; padding: 10px;" class="info_neutral">
				...
				<td valign="top">
					...
					<tr>
						<td width="300" valign="top">
							...
							<div id="home_box_start" class="home_box" style="width: 280px;">
								<div class="edit_title round_top" style="margin-right: 0px; margin-bottom: 0px; padding: 15px; padding-left: 20px; background: #FFFFFF; border-bottom: 0px; text-shadow: none; -webkit-box-shadow: -0px 7px 29px rgba(0, 0, 0, 0.34); -moz-box-shadow: 0px 7px 29px rgba(0, 0, 0, 0.34); box-shadow: 0px 7px 29px rgba(0, 0, 0, 0.34);">
									<div style="">Start here.  Things to do.</div>
								</div>
								<div style="background: url( ../pics/bg_setup.png ) no-repeat #5CAED6; background-position: bottom right; padding: 15px; box-shadow: -2px 0 16px 1px rgba(0,0,0,.1);" class="round_bottom">
									...
									<tr>
										<td><img src="../pics/icons/numbers/2.png" width="16" height="16" border="0" alt="" style="padding: 2px; background: #FFFFFF;" class="round"></td>
										<td><a href="ops.php" style="color: #FFFFFF;">Add Chat Operator</a></td>
									</tr>
									<tr>
										<td><img src="../pics/icons/numbers/3.png" width="16" height="16" border="0" alt="" style="padding: 2px; background: #FFFFFF;" class="round"></td>
										<td><a href="ops.php?jump=assign" style="color: #FFFFFF;">Assign Operator to Department</a></td>
									</tr>
									<tr>
										<td><img src="../pics/icons/numbers/4.png" width="16" height="16" border="0" alt="" style="padding: 2px; background: #FFFFFF;" class="round"></td>
										<td><a href="code.php" style="color: #FFFFFF;">Copy HTML Code</a></td>
									</tr>
									<tr>
										<td><img src="../pics/icons/numbers/5.png" width="16" height="16" border="0" alt="" style="padding: 2px; background: #FFFFFF;" class="round"></td>
						...
						<td valign="top">
							...
							<div class="home_box" style="">
								...
								<div style="margin-top: 15px;">
									<div style="margin-bottom: 20px;"><table cellspacing=0 cellpadding=0 border=0><tr><td><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""></td><td style="padding-left: 5px;"> <?php echo ( $operator_pic_display ) ? "All or some of the" : "" ; ?> <a href="interface_op_pics.php">Operator Profile Pictures</a> are <?php echo ( $operator_pic_display ) ? "<span class=\"info_good\">visible</span>" : "<span class=\"info_warning\">not visible</span>" ; ?> to the visitor during a chat session.</td></tr></table></div>

									<div style="margin-bottom: 20px;"><table cellspacing=0 cellpadding=0 border=0><tr><td><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""></td><td style="padding-left: 5px;"> The <a href="interface_chat_msg.php">Chat End Message</a> is <?php echo ( $chat_end_message_enabled ) ? "<span class=\"info_good\">enabled</span> for a department" : "<span class=\"info_warning\">not enabled</span>" ; ?>.</td></tr></table></div>

									<div style="margin-bottom: 20px;"><table cellspacing=0 cellpadding=0 border=0><tr><td><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""></td><td style="padding-left: 5px;"> The <a href="code_autostart.php">Automatic Start Chat</a> is <?php echo count( $auto_connect_array ) ? "<span class=\"info_good\">enabled</span> for a department" : "<span class=\"info_warning\">not enabled</span>" ; ?>.</td></tr></table></div>

									<div style="margin-bottom: 20px;"><table cellspacing=0 cellpadding=0 border=0><tr><td><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""></td><td style="padding-left: 5px;"> The <a href="interface_gdpr.php">GDPR</a> is <?php echo ( $gdpr_msg_enabled ) ? "<span class=\"info_good\">enabled</span> for a department" : "<span class=\"info_warning\">not enabled</span>" ; ?>.</td></tr></table></div>

									<div style="margin-bottom: 20px;"><table cellspacing=0 cellpadding=0 border=0><tr><td><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""></td><td style="padding-left: 5px;"> The Operator and Setup Admin login screens are <b><a href="interface.php?jump=screen"><?php echo ( $CONF["screen"] == "same" ) ? "the same URL" : "separate URLs" ; ?></a></b>.</td></tr></table></div>

									<div style="margin-bottom: 20px;"><table cellspacing=0 cellpadding=0 border=0><tr><td><img src="../pics/icons/bullet_red.png" width="12" height="12" border="0" alt=""></td><td style="padding-left: 5px;"> There are <b><a href="settings.php?jump=sips"><?php echo $ips_spam ?> blocked IPs</a></b> from chat access.  Blocked IPs will always see an offline chat icon.</td></tr></table></div>
								</div>
							</div>
					...
					<tr>
						<td valign="top" colspan=2 style="padding-top: 55px;">
							...
							<div class="home_box" style="border-top: 1px dashed #D6E4F2;">
			...
			<div style="margin-top: 5px; text-align: justify;">
				...
				<div style="margin-top: 5px;" class="info_warning">
					...
					<tr>
						...
						<td style="padding-left: 5px;">Please double check the timezone selection because future timezone updates will reset the chat total accept/decline stats and other time related data.</td>
					</tr>
					</table>
				</div>
			</div>
