...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div class="op_submenu2" id="menu_tags_tags" onClick="location.href='transcripts_tags.php?jump=tags'">Create/Edit Tags</div>
			<div style="clear: both"></div>
		</div>

		<div style="margin-top: 15px;">Categorize chats with tags (example: "important", "sales", "high interest").  <a href="ops.php">Operators</a> will see a "tag" selection dropdown menu on the operator console.</div>
