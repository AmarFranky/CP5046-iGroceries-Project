...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div id="foot_main" style="margin-top: 25px;">
			...
			<div style="text-shadow: none; text-align: justify;">
				On pages that has the <a href="code.php">Standard HTML Code</a>, the system will store the visitor's footprint data as they navigate from page to page.  To conserve server resources and to optimize system response, the footprint data is stored for maximum of <b><?php echo $VARS_FOOTPRINT_STATS_EXPIRE ?> days</b>.  Reports greater then <b><?php echo $VARS_FOOTPRINT_STATS_EXPIRE ?> days</b> will be automatically cleared.  It is recommended to utilize a traffic statistics tool such as <a href="http://www.google.com/analytics/" target="_blank">Google Analytics</a> for a detailed website traffic information.
		...
		<div id="foot_settings" style="margin-top: 25px; text-align: justify;">
			...
			<div style="float: left; margin-left: 2px; min-height: 350px; width: 45%;" class="info_info">
				<div style="font-size: 14px; font-weight: bold;">Chat Icon Status Check</div>

				<div style="margin-top: 15px;">
					(default is On) On pages that has the <a href="code.php">Standard HTML Code</a>, while the visitor is viewing the page, the system will ping the server every <?php echo $VARS_JS_CHATICON_CHECK ?> seconds to update and gather various information.  The resource usage is very minimal and takes milliseconds to process.  However, to reduce server resource usage, switch the setting to Off.
