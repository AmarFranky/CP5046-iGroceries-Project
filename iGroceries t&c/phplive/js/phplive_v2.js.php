<?php
	...
	$svg_icons_online = isset( $svg_icons[$deptid]["online"] ) ? $svg_icons[$deptid]["online"] : Array() ;
	$svg_icons_offline = isset( $svg_icons[$deptid]["offline"] ) ? $svg_icons[$deptid]["offline"] : Array() ;
	if ( $datauri )
	{
...
phplive_globals["popout"] = <?php echo ( !$preview && ( !isset( $VALS["POPOUT"] ) || ( isset( $VALS["POPOUT"] ) && ( $VALS["POPOUT"] == "on" ) ) ) ) ? 1 : 0 ?> ;
...
phplive_globals["alt_empopout"] = "<?php echo isset( $alttext_array_dept["empopout"] ) ? $alttext_array_dept["empopout"] : "" ; ?>" ;
...
phplive_globals["phplive_misc_01"] = <?php echo ( isset( $VARS_MISC_MOBILE_MAX_QUIRK ) && $VARS_MISC_MOBILE_MAX_QUIRK ) ? 1 : 0 ?> ;
