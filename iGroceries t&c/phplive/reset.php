		...
		if ( $setup_admin_password )
		{
			...
			if ( isset( $data["adminID"] ) ) {
				...
				print "<!doctype html><html><body><div style='padding: 25px; font-family: Arial; font-size: 12px;'>
					<div style='background: #FBF7B4; border: 1px solid #F1E5A3; padding: 5px; color: #806732; font-size: 18px; text-shadow: 1px 1px #FBF9DB; -moz-border-radius: 10px; border-radius: 10px;'>Reset Success!</div>
			...
			} else { print "<!doctype html><html><body><div style='padding: 25px; font-family: Arial; font-size: 12px;'><div style='background: #FD7D7F; border: 1px solid #E16F71; padding: 5px; color: #FFFFFF; -moz-border-radius: 10px; border-radius: 10px;'>Error: Could not locate the master Setup Admin account to reset.</div></div></body></html>" ;
			} if ( isset( $dbh ) && $dbh['con'] ) { database_mysql_close( $dbh ) ; }
		}
		else { print "<!doctype html><html><body><div style='padding: 25px; font-family: Arial; font-size: 12px;'><div style='background: #FD7D7F; border: 1px solid #E16F71; padding: 5px; color: #FFFFFF; -moz-border-radius: 10px; border-radius: 10px;'>Error: The variable <b><big>\$setup_admin_password</big></b> must be provided.</div></div></body></html>" ; }
	}
	else {
		print "<!doctype html><html><body><div style='padding: 25px; font-family: Arial; font-size: 12px;'>
