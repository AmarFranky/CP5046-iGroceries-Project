<?php
	...
	{
		global $CONF ; global $VERSION ; global $PHPLIVE_HOST ; global $KEY ; global $dbh ; global $embed ;
		...
		if ( $errno )
		{
			if ( preg_match( "/gethostbyaddr/", $errmsg ) ) { return true ; }
				...
				$embed_close = ( isset( $embed ) && $embed ) ? "<div style=\"margin-top: 55px;\"><center><button type=\"button\" onClick=\"parent.phplive_embed_window_close( )\" style=\"padding: 10px; width: 120px;\">Close</button></center></div>" : "" ;
