<?php
	...
	else if ( $action === "alerts" )
	{
		...
		for ( $c = 0; $c < count( $declines ); ++$c )
		{
			...
			$json_data .= "{ \"ces\": \"$ces\", \"created\": \"$created\", \"status\": \"$status\", \"status_msg\": \"$declineinfo[status_msg]\", \"deptid\": \"$declineinfo[deptID]\", \"vname\": \"$vname\", \"vemail\": \"$vemail\", \"ip\": \"$ip\", \"question\": \"$question\", \"onpage_url\": \"$onpage_url\", \"onpage_title\": \"$onpage_title\", \"custom_vars\": \"$custom_vars_string\" }," ;
		}
