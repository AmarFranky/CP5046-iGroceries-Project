<?php
	...
	$code_maps = ( isset( $VALS_ADDONS ) && isset( $VALS_ADDONS["code_maps"] ) ) ? unserialize( base64_decode( $VALS_ADDONS["code_maps"] ) ) : Array() ;
	/***************************************/
	/* a check to make sure code.php is not in condition to limit confusion */
	$code_mapper_code_exists = 0 ;
	...
	$code = "&lt;!-- BEGIN PHP Live! HTML Code [V3] --&gt;-nl-&lt;span style=\"color: #0000FF; text-decoration: underline; line-height: 0px !important; cursor: pointer;$position_css\" id=\"phplive_btn_$now\"&gt;&lt;/span&gt;-nl-&lt;script data-cfasync=\"false\" type=\"text/javascript\"&gt;-nl--nl-(function() {-nl-var phplive_href = encodeURIComponent( location.href ) ;-nl-var phplive_e_$now = document.createElement(\"script\") ;-nl-phplive_e_$now.type = \"text/javascript\" ;-nl-phplive_e_$now.async = true ;-nl-phplive_e_$now.src = \"$source_url%%text_string%%&r=\"+phplive_href ;-nl-document.getElementById(\"phplive_btn_$now\").appendChild( phplive_e_$now ) ;-nl-if ( [].filter ) { document.getElementById(\"phplive_btn_$now\").addEventListener( \"click\", function(){ phplive_launch_chat_$deptid() } ) ; } else { document.getElementById(\"phplive_btn_$now\").attachEvent( \"onclick\", function(){ phplive_launch_chat_$deptid() } ) ; }-nl-})() ;-nl-//phplive_auto-nl-&lt;/script&gt;-nl-&lt;!-- END PHP Live! HTML Code [V3] --&gt;" ;
...
<!--
	...
	$(document).ready(function()
	{
		...
		if ( typeof( show_div ) == "function" ) { show_div( "code_main" ) ; }
...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div id="div_code_options">
				...
				<?php if ( $select_depts ): ?>
				<div>
					<span class="info_menu_focus_shadow">Department</span>
				</div>
				<div style="margin-top: 5px;">
					<table cellspacing=0 cellpadding=0 border=0>
					<tr>
						<td><select name="deptid" id="deptid" style="font-size: 16px; border: 1px solid #45B8DB; background: #5BC0DE; color: #FFFFFF;" OnChange="switch_dept( this )">
						...
						<td style="padding-left: 15px;">
							...
							<div style="margin-top: 10px;">When the chat icon is clicked, visitors will be routed to the <span class="info_misc"><b><?php echo isset( $deptgroupinfo["name"] ) ? $deptgroupinfo["name"] : $deptinfo["name"] ; ?></b></span> department.</div>
						</td>
						<?php endif ; ?>
					</tr>
					</table>
			...
			<div style="margin-top: 25px;">
				<form id="proto_pos">
				<div>
					<span class="info_menu_focus_shadow">Chat Icon Position</span>
				</div>
				<div style="margin-top: 5px;">
					<select name="position" id="position" onChange="toggle_code()" style="">
			...
			<div style="margin-top: 25px;">
				...
				<tr>
					<td width="48%" valign="top">
						<form id="form_proto">
						<div>
							<span class="info_menu_focus_shadow">HTTP or HTTPS</span>
						</div>
					...
					<td width="48%" valign="top">
						<div>
							<span class="info_menu_focus_shadow">Embed Chat Window Position</span>
						</div>
						<div class="info_neutral" style="margin-top: 10px;">
							<div style="margin-top: 5px;">When the chat icon is clicked, open the embed chat window at the bottom right or the bottom left of the page.  This setting only applies if the <a href="icons.php?jump=settings">chat icon behavior</a> is set to <b>embed</b>.</div>
							<div style="margin-top: 5px;">
			...
			<div style="margin-top: 15px;">
				...
				<div style="display: none; margin-bottom: 5px; margin-bottom: 15px; padding: 15px; text-align: center;" class="info_good" id="div_new_code">
				...
				<?php if ( $code_mapper_code_exists ): ?>
				...
				<div style="margin-bottom: 5px;">
					...
					<div style="margin-top: 5px; padding: 8px; font-size: 12px; font-weight: normal; cursor: pointer;" class="op_submenu" onClick="toggle_html_code('noj')" id="menu_html_code_noj">No JavaScript</div>
					<div style="margin-top: 5px; padding: 8px; font-size: 12px; font-weight: normal; cursor: pointer;" class="op_submenu" onClick="toggle_html_code('direct')" id="menu_html_code_direct">URL Link</div>
					<div style="clear: both;"></div>
				</div>
