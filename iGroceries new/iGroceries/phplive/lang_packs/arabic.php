...
/***********************************************************************/
/* Please submit corrections to feedback@phplivesupport.com - Thank you! */
...
$LANG["CHAT_TRANSFER_TIMEOUT"] = "نقل الدردشة غير متوفرة في هذا الوقت." ;
...
$LANG["CHAT_JS_INVALID_EMAIL"] = "نسق البريد الإلكتروني غير صحيح.  (مثال: name@domain.com)" ;
...
$LANG["CHAT_JS_CUSTOM_BLANK"] = "يرجى تقديم جميع الحقول المطلوبة." ;
...
$LANG["TXT_DISCONNECT"] = "نهاية المحادثة" ;
...
$LANG["CHAT_ERROR_DC"] = "خطأ في الإتصال. يرجى تحديث الصفحة وحاول مرة أخرى." ;
$LANG["TXT_COMMENT"] = "تعليق" ;
$LANG["TXT_UPLOAD_FILE"] = "إرسال ملف" ;
$LANG["TXT_UPLOAD_SEND"] = "إرسال..." ;
$LANG["TXT_RATING"] = "تقييم" ;
$LANG["CHAT_INVITE_DECLINED"] = "رفض الزائر دعوة الدردشة." ;
$LANG["TXT_DOWNLOAD"] = "تحميل" ;
?>