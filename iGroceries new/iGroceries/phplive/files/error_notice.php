...
<div style="padding: 10px;">
	...
	<div style="margin-top: 10px; background: #FD7D7F; border: 1px solid #E16F71; padding: 5px; color: #FFFFFF; -moz-border-radius: 10px; border-radius: 10px;">
		...
		<tr>
			<td><div style="background: #FFFFFF; color: #524F4F; padding: 5px; -moz-border-radius: 5px; border-radius: 5px;">Version</div></td>
			<td>%version%</td>
		</tr>
		</table>
	</div>
	<div style="margin-top: 15px;">
		<div id="solution_default" style="">
			...
			<div style="margin-top: 15px;"><span style="">If you are the website admin <a href="%solution%" target="_blank" style="background: #3AC0C3; border: 1px solid #33AAAD; padding: 5px; color: #FFFFFF;">click here to check for solutions</a>.</span></div>
			%embed_close%
		</div>
