...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<tr>
				<td>
					<select name="deptid" id="deptid" onChange="switch_dept( this )">
			...
			<div style="padding-top: 15px;">
				...
				<div style="margin-top: 5px;"><img src="../pics/icons/bullet_purple.png" width="16" height="16" border="0" alt=""> "Operator Initiated Chat Request".  The operator initiated a chat request to the visitor but the chat request was declined by the visitor or the visitor did not take action.</div>
