...
class Admin extends CI_Controller {
	...
	{
		$data['products']=$this->AdminModel->count_products();
		$data['orders']=$this->AdminModel->count_orders();
		$data['customers']=$this->AdminModel->count_customers();
	...
	{
		$data['contacts']=$this->AdminModel->get_contacts();
		$this->load->view('admin/header');
		$this->load->view('admin/manage_messages',$data);
	}
