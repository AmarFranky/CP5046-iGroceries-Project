<?php
	...
	$emarketing_addon_enabled = is_file( "../addons/emarketing/emarketing.php" ) ? 1 : 0 ;
...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div class="op_submenu2" onClick="location.href='reports_marketing.php'">Campaign Clicks</div>
			<!-- <div class="op_submenu" onClick="location.href='marketing_ga.php'">Google Analytics</div> -->
			<?php if ( $emarketing_addon_enabled ): ?>
			<div class="op_submenu2" onClick="location.href='../addons/emarketing/emarketing.php'"><img src="../addons/emarketing/pics/email.png" width="10" height="10" border="0" alt=""> Email Marketing</div>
			<div class="op_submenu2" onClick="location.href='../addons/emarketing/emarketing_export.php'"><img src="../addons/emarketing/pics/email.png" width="10" height="10" border="0" alt="">Email Marketing Stats</div>
			<?php endif ?>
			<?php if ( is_file( "../addons/feedback/feedback.php" ) ): ?>
			<div class="op_submenu2" onClick="location.href='../addons/feedback/feedback.php'"><img src="../addons/feedback/pics/profile_sm_white.png" width="10" height="10" border="0" alt=""> Feedback</div>
			<div class="op_submenu2" onClick="location.href='../addons/feedback/feedback_export.php'"><img src="../addons/feedback/pics/profile_sm_white.png" width="10" height="10" border="0" alt="">Feedback Stats</div>
			<?php endif ?>
			<div style="clear: both"></div>
		</div>

		<div style="margin-top: 25px;">
			Campaign Tracking will track your marketing campaign click-through rates.  Simply append the generated query key to your campaign URL.  <b>IMPORTANT:</b> The landing page must have the chat icon <a href="code.php">HTML Code</a> to capture the query key for tracking.
		</div>
		...
		<div class="edit_wrapper" style="padding: 5px; margin-top: 55px;">
			...
			<div style="margin-top: 10px;">
				...
				<tr>
					<td>
						Campaign name (example: "Google PPC")
				...
				<tr>
					<td>
						Select the campaign reference color (the indication color on the operator console traffic monitor)
				...
				<tr>
					<td><div style="padding-top: 10px;">* after making changes, if an operator console is open, they will need to log out and log back in for the name and color changes to take effect on the traffic monitor</div></td>
				</tr>
				</table>
				</form>
			</div>
