<?php
	...
	FUNCTION Util_Upload_File( $icon, $deptid )
	{
		...
		if ( ( $icon == "profile" ) && isset( $_SERVER['CONTENT_LENGTH'] ) && ( $_SERVER['CONTENT_LENGTH'] > 250000 ) )
			$error = "File size must be 250KB or less." ;
		else if ( isset( $_SERVER['CONTENT_LENGTH'] ) && ( $_SERVER['CONTENT_LENGTH'] > 300000 ) )
			$error = "File size must be 300KB or less." ;
