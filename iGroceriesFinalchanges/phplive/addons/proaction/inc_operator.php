<div style="display: none; position: absolute; top: 0px; right: 0px; background: #FFFFFF; color: #2F3535; padding: 15px; box-shadow: 3px 3px 15px rgba(0, 0, 0, 0.2); width: 255px; cursor: pointer; z-Index: 1000; -moz-border-radius: 5px; border-radius: 5px;" id="proaction_box" onClick="toggle_proaction_box(0, '')">
